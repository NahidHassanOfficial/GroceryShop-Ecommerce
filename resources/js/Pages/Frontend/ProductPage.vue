                        ...
                        <div class="ps-lg-10 mt-6 mt-md-0">
                            ...
                            <div class="mt-3 row justify-content-start g-2 align-items-center">
                                <div class="col-xxl-4 col-lg-4 col-md-5 col-5 d-grid">
                                    <!-- button -->
                                    <!-- btn -->
                                    <button @click="addToCart(product, quantity)" type="button" class="btn btn-primary">
                                        ...
                                        <div class="col-md-8">
                                            <div class="mb-10">
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6">
                                                    <!-- img -->
                                                    <!-- img -->
                                                    <img src="../../../../public/images/avatar/avatar-10.jpg" alt=""
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <div>
                                                            <div class="border icon-shape icon-lg border-2">
                                                                <!-- img -->
                                                                <img src="../../../../public/images/products/product-img-1.jpg"
                                                                    alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="border icon-shape icon-lg border-2 ms-1">
                                                                <!-- img -->
                                                                <img src="../../../../public/images/products/product-img-2.jpg"
                                                                    alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="border icon-shape icon-lg border-2 ms-1">
                                                                <!-- img -->
                                                                <img src="../../../../public/images/products/product-img-3.jpg"
                                                                    alt="" class="img-fluid" />
                                                            </div>
                                                        </div>
                                                        <!-- icon -->
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                    <!-- img -->
                                                    <img src="../../../../public/images/avatar/avatar-12.jpg" alt=""
                                                        class="rounded-circle avatar-lg" />
                                                    <div class="ms-5">
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                    <!-- img -->
                                                    <img src="../../../../public/images/avatar/avatar-9.jpg" alt=""
                                                        class="rounded-circle avatar-lg" />
                                                    <div class="ms-5">
                                                ...
                                                <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                    <!-- img -->
                                                    <img src="../../../../public/images/avatar/avatar-8.jpg" alt=""
                                                        class="rounded-circle avatar-lg" />
